  ...
  if (element) {
    ...
    return (
        <div className="hero__container flex flex-col w-full h-[100vh]">
            ...
            <Link to="/catalog" className="px-8 py-4 flex items-center justify-center cursor-pointer bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg sm:text-sm md:text-lg font-semibold transition-colors">

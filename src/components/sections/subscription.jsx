...
function Subscription() {
    return (
        <div id="subscription" className="sub__container bg-white p-6 pt-5 scroll-mt-18 md:scroll-mt-46 flex justify-center items-center flex-row  w-[97%] md:max-w-[1600px] mx-auto shadow-2xl shadow-black/50">

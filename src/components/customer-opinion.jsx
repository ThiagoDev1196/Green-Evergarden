...
function CustomerOpinion({ picture, name, text }) {
    return (
        <div className="customer__opinion__container bg-white shadow-lg shadow-black/20 m-2 flex flex-col justify-center items-center  w-[97%] md:max-w-[1540px] p-2 md:p-4 md:flex-row ">

...
function Subscription() {
    return (
        <div id="subscription" className="sub__container p-6 pt-5 scroll-mt-18 md:scroll-mt-46 flex justify-center items-center flex-row  w-[97%] md:max-w-[1540px] mx-auto shadow-2xl shadow-black/50">
            ...
            <div className="sub__input__container flex flex-col items-center justify-end shadow-2xl md:shadow-none p-2  flex-[2] text-black md:bg-none">
              ...
              <div className="sub__input flex justify-center flex-col items-center bg-[#ffffffE6]">
                <img src="/subimg3.jpg" className="w-full max-w-[400px] md:hidden"/>
            ...
            <div className="sub__img hidden md:flex flex-[1] lg:flex-[2]">
                <img src="/subimg3.jpg" className="h-[450px] w-full object-cover"/>
            </div>
        </div>
    );
}
